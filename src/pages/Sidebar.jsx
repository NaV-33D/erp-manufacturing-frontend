...
const SidebarLayout = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:relative z-50 h-screen bg-white border-r border-gray-200
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-4 border-b">
          <div className="font-bold text-lg text-blue-600">ERP System</div>
        ...
        <div className="border-t p-4">
          <button
            onClick={handleLogout}
            className="w-full flex items-center gap-2 text-red-600 hover:bg-red-50 px-3 py-2 rounded-lg text-sm"
          >
            <LogOut size={18} />
            Logout
          </button>
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="h-16 bg-white border-b flex items-center px-6 shadow-sm">
          <button className="md:hidden mr-4" onClick={() => setIsOpen(true)}>
            <Menu size={20} />
          </button>
