...
const TABS = [
  { id: "sku", label: "Stock by SKU", component: <StockBySkuTab /> },
  // {
  //   id: "location",
  //   label: "Stock by Location",
  //   component: <StockByLocationTab />,
  // },
  // { id: "holds", label: "Holds / Quarantine", component: <InventoryHolds /> },
  ...
  return (
    <div>
      <div className="mx-auto 2xl:max-w-[1900px]">
        <PageHeader
          title="Inventory"
          subtitle="View stock by SKU, location, holds and transactions"
          actions={
            <>
              <button className="flex items-center gap-2 rounded-md border border-gray-200 bg-white px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                <Download size={16} />
                Export
              </button>
